...
<div class="m-3">
  <div class="mb-2">
    <v-button type="primary" @click="onAdd">新增导出计划</v-button>
  </div>
...
import { queryPlan, deletePlan } from '@/api/export-plan'
import AddPlan from './add-plam/index.vue'

@Component({
  components: { AddPlan }
})
export default class ExportPlan extends Vue {
  dataSource: any[] = []
